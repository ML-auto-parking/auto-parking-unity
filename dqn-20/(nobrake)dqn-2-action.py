...
train_start_step = 100000 / 10  # 초기 탐험
first_step = 100000
run_step = first_step if train_mode else 0  # 훈련 스텝
test_step = 5000  # 테스트 스텝
...
load_path = f"./saved_models/{game}/DQN/20240602012700"
# 20240530073302
...
if __name__ == '__main__':
    ...
    for step in range(run_step + test_step):
        ...
        if done:
            if(terminal_steps.reward>=10000): sucess_episode+=1
            episode += 1
            scores.append(score)
            score = 0
            ...
            if episode % print_interval == 0:
                ...
                agent.write_summary(mean_score, mean_loss, agent.epsilon,sucess_episode, episode)
                losses, scores = [], []
