...
for _ in range(10):
    ...
    train_start_step = mem_maxlen//10  # 초기 탐험
    first_step = 300000 + train_start_step
    ...
    if __name__ == '__main__':
        ...
        env = UnityEnvironment(file_name=env_name, side_channels=[engine_configuration_channel], worker_id=16)
        env.reset()
        ...
        for step in range(run_step + test_step):
            ...
            if len(decision_steps) > 0:  # 에이전트가 존재하는지 확인
                ...
                print(f"Wheel Torque Delta: {wheel_torque_delta-1}, Steering Angle Delta: {steering_angle_delta-1}")
                ...
                print(f"Wheel Torque Action: {wheel_torque_action}, Steering Angle Action: {steering_angle_action}")
                ...
                # print(f"Action Tuple: {action_array}")
