...
for _ in range(10):
    ...
    save_path = f"./saved_models/{game}/DQN/a2-s2/ver-{version}/0616/{date_time}"
    ...
    env = UnityEnvironment(file_name=env_name, side_channels=[engine_configuration_channel], worker_id=24)
    env.reset()

    behavior_name = list(env.behavior_specs.keys())[0]
    spec = env.behavior_specs[behavior_name]
    action_shape = spec.action_spec.discrete_branches
