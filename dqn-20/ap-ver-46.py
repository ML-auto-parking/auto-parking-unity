...
for _ in range(10):
    ...
    first_step = 10000000 + train_start_step
    ...
    load_path = f"./saved_models/{game}/DQN/a2-s2/ver-{version}/06-10 05_55"
    # 20240602012700
    ...
    env = UnityEnvironment(file_name=env_name, side_channels=[engine_configuration_channel], worker_id=5)
    env.reset()
