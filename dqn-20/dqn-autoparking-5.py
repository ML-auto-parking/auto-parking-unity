...
for _ in range(10):
    ...
    load_path = f"./saved_models/{game}/DQN/a3-s2/ver-{version}/06-05 03:20"
    # 20240530073302
    ...
    if __name__ == '__main__':
        ...
        env = UnityEnvironment(file_name=env_name, side_channels=[engine_configuration_channel], worker_id=8)
        env.reset()
