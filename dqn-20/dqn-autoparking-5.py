...
train_start_step = first_step//10  # 초기 탐험
...
load_path = f"./saved_models/{game}/DQN/20240526155246"
...
class DQNAgent:
    def __init__(self, image_dim, vector_dim, agent_pos_dim):
        self.network = DQN(image_dim, vector_dim, agent_pos_dim, action_size, action_dim).to(device)
...
if __name__ == '__main__':
    ...
    print(vector_obs.shape, image_obs.shape, agent_pos_obs.shape)
