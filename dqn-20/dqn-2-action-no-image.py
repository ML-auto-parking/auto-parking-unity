...
load_path = f"./saved_models/{game}/DQN/20240604104022"
# 20240602012700
...
class DQNAgent:
    ...
    def train_model(self, beta=0.4):
        ...
        vectors, agent_pos, actions, rewards, next_vectors, next_agent_pos, dones = map(
            lambda x: torch.FloatTensor(x).to(device), [vectors, agent_pos, actions, rewards, next_vectors, next_agent_pos, dones])
